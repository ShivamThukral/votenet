...
from my_ap_helper import APCalculator, parse_predictions, parse_groundtruths

parser = argparse.ArgumentParser()
parser.add_argument('--model', default='my_votenet', help='Model file name [default: votenet]')
parser.add_argument('--dataset', default='sunrgbd', help='Dataset name. sunrgbd or scannet. [default: sunrgbd]')
parser.add_argument('--checkpoint_path', default=None, help='Model checkpoint path [default: None]')
parser.add_argument('--log_dir', default='log', help='Dump dir to save model checkpoint [default: log]')
parser.add_argument('--dump_dir', default=None, help='Dump dir to save sample outputs [default: None]')
parser.add_argument('--num_point', type=int, default=20000, help='Point Number [default: 20000]')
parser.add_argument('--num_target', type=int, default=8, help='Proposal number [default: 256]')
...
parser.add_argument('--max_epoch', type=int, default=20, help='Epoch to run [default: 180]')
...
if FLAGS.dataset == 'sunrgbd':
    ...
    from my_sunrgbd_detection_dataset import SunrgbdDetectionVotesDataset, MAX_NUM_OBJ
...
print('-'*30 + "Totol Dataset Lengths = train : {}  test : {}".format(len(TRAIN_DATASET), len(TEST_DATASET)))
TRAIN_DATALOADER = DataLoader(TRAIN_DATASET, batch_size=BATCH_SIZE,
                              shuffle=True, num_workers=4, worker_init_fn=my_worker_init_fn)
TEST_DATALOADER = DataLoader(TEST_DATASET, batch_size=BATCH_SIZE,
                             shuffle=True, num_workers=4, worker_init_fn=my_worker_init_fn)

print('-'*30 + "Totol Batch Dataset Lengths = train : {}  test : {}".format(len(TRAIN_DATALOADER), len(TEST_DATALOADER)))
