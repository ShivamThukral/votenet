...
def viz_obb(pc, label, mask, angle_classes, angle_residuals,
            size_classes, size_residuals, dataloader_dump_dir =os.path.join(BASE_DIR, 'data_loader_dump')):
...
if __name__ == '__main__':
    d = SunrgbdDetectionVotesDataset(use_height=False, use_color=False, use_v1=False, augment=True, num_points=20000)
    sample = d[350]
    ...
    pc_util.write_ply(sample['point_clouds'], os.path.join(dataloader_dump_dir, 'pc.ply'))
